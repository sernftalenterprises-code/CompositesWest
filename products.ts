export interface Product {
  ...
  /**
   * Per-roll price in USD. Optional — products without a price stay quote-only.
   * Must match the price on the Stripe Payment Link.
   */
  priceUsd?: number;
  /**
   * Stripe Payment Link URL (https://buy.stripe.com/...). When set, the product
   * page shows a "Buy now" button. Create links in the Stripe dashboard and set
   * their confirmation redirect to https://compositeswest.com/thank-you/
   * (see STRIPE.md).
   */
